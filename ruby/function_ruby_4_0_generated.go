...
// RbSetAdd calls `rb_set_add` in C
//
// Original definition is following
//
//	_Bool rb_set_add(VALUE set, VALUE element)
func RbSetAdd(set VALUE, element VALUE) Bool {
	return Bool(C.rb_set_add(C.VALUE(set), C.VALUE(element)))
}
...
// RbSetClear calls `rb_set_clear` in C
//
// Original definition is following
//
//	VALUE rb_set_clear(VALUE set)
func RbSetClear(set VALUE) VALUE {
	return VALUE(C.rb_set_clear(C.VALUE(set)))
}

// RbSetDelete calls `rb_set_delete` in C
//
// Original definition is following
//
//	_Bool rb_set_delete(VALUE set, VALUE element)
func RbSetDelete(set VALUE, element VALUE) Bool {
	return Bool(C.rb_set_delete(C.VALUE(set), C.VALUE(element)))
}
...
// RbSetForeach calls `rb_set_foreach` in C
//
// Original definition is following
//
//	void rb_set_foreach(VALUE set, int (*func)(VALUE element, VALUE arg), VALUE arg)
func RbSetForeach(set VALUE, arg2 unsafe.Pointer, arg VALUE) {
	C.rb_set_foreach(C.VALUE(set), toCFunctionPointer(arg2), C.VALUE(arg))
}

// RbSetLookup calls `rb_set_lookup` in C
//
// Original definition is following
//
//	_Bool rb_set_lookup(VALUE set, VALUE element)
func RbSetLookup(set VALUE, element VALUE) Bool {
	return Bool(C.rb_set_lookup(C.VALUE(set), C.VALUE(element)))
}

// RbSetNew calls `rb_set_new` in C
//
// Original definition is following
//
//	VALUE rb_set_new(void)
func RbSetNew() VALUE {
	return VALUE(C.rb_set_new())
}

// RbSetNewCapa calls `rb_set_new_capa` in C
//
// Original definition is following
//
//	VALUE rb_set_new_capa(size_t capa)
func RbSetNewCapa(capa SizeT) VALUE {
	return VALUE(C.rb_set_new_capa(C.size_t(capa)))
}

// RbSetSize calls `rb_set_size` in C
//
// Original definition is following
//
//	size_t rb_set_size(VALUE set)
func RbSetSize(set VALUE) SizeT {
	return SizeT(C.rb_set_size(C.VALUE(set)))
}
